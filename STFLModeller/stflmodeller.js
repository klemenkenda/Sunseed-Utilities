...
function makePrediction(fromDataDate, startPredictionDate, predictSensor) {    
    ...
    console.log("Reading sensor data for " + predictSensor + " until " + tomorrow.toMysqlDateFormat());
...
// due to some errors on Telekom we make this interface dummy
var pirmq = new PredictionInterface('dummy');
...
var job = schedule.scheduleJob('0 0 7 * * *', function() {
    startPrediction();
});
